...
%
% Example
% ali_ExpGen('basedir', '/local/AliManStims', 'experimentname', 'ali_Disparity', 'repetitions', 8, 'mainexpt', struct('et', 'dx', 'st', 'rds', 'nt', 8, 'em', 0, 'ie', 0.02, 'ce', 1, 'sa',3), 'oddball', struct('ce',0,'st', 'rds', 'op','-sq', 'sa', 0, 'sl', 0))  
%
% Depedencies
% parsevarargin.m
% ali_savestruct2file
