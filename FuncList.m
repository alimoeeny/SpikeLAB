...
d = DistanceMeasure(C, cl, type, varargin)
GetComment(DATA,a,b)
AddComment(a,b,str)
...
CheckClusters(DATA, type)
DATA = ConvertExclusion(DATA)
DATA = CheckExclusion(DATA)
...
voffset = SetVOffset(DATA, AllSpikes, e)
